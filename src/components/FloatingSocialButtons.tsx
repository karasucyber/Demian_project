  ...
  return (
    <div className="fixed right-6 bottom-6 z-50 flex flex-col gap-4">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="group flex items-center justify-center w-14 h-14 rounded-full bg-black border-2 border-black hover:bg-white hover:border-black transition-all duration-300 shadow-lg"
        aria-label="WhatsApp"
      >
        <MessageCircle className="h-6 w-6 text-white group-hover:text-black transition-colors" />
      </a>
    </div>
  );
}
